 ...
 */
public class HttpInserimentoVoti extends HttpConnect {

    private Activity a;
    private HttpInserimentoVoti httpInserimentoVoti;

    public HttpInserimentoVoti(Activity a, HashMap<String, String> datiInvio) {
        super(a, Constant.URL_BUZZI + "inserimentoVoti.php", datiInvio, "", new HttpOptions().showProgressBar(false).setErrorActivity(true));
        this.a = a;
