 ...
 * e si occupa di mostrare la lista delle comunicazioni.
 *
 ...
 */
public class ListAdapterComunicazioni extends BaseAdapter {

    private ArrayList<String> testi;
    private Activity mainActivity;

    public ListAdapterComunicazioni(Activity mainActivity, ArrayList<String> testi) {
        this.testi = testi;
