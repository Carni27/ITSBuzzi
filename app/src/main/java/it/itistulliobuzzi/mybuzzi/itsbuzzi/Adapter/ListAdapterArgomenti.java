 ...
 * e si occupa di mostrare la lista degli argomenti.
 * <p>
 ...
 */
public class ListAdapterArgomenti extends BaseAdapter {

    private ArrayList<String> testi;
    private Activity mainActivity;

    public ListAdapterArgomenti(Activity mainActivity, ArrayList<String> testi) {
        this.testi = testi;
